...
<!--MAIN Content-->
            ...
            <!-- <div class="row clearfix">
                <div class="col-lg-12">
                    <div class="card">
                        <div class="header">
                            <h2>Transfusion History<small>All Previous Blood Transfusion History</small> </h2>
                        </div>
                        <div class="body">
                                ...
                                <div class="col-sm-4">
                                 ...
                                 <div class="col-sm-12">
                                    <div class="form-group m-t-20">
                                        <textarea rows="2" class="form-control" placeholder="In Detail Report Of ECG" name="report"></textarea>
                                    </div>
                                </div>
                                <div class="col-sm-4">
                                      <div class="form-group">
