                                            ...
                                            <li>
                                                <div class="form-group">
                                                    <select class="form-control show-tick" name="pid" >
                                                        ...
                                                        <?php 
                                                        $result4= mysqli_query($conn,"SELECT * FROM hospital.appointment where requestedServiceId='11'");
                            ...
                            <div class="table-responsive m-t-20">
                                <table class="table table-filter table-hover m-b-0 ">
                                    <tbody>
                                        ...
                                        <?php 
                                        $result6= mysqli_query($conn,"SELECT * FROM hospital.appointment where requestedServiceId='11'");
                                ...
                                <div class="col-sm-4">
                                 ...
                                 <div class="col-sm-12">
                                    <div class="form-group m-t-20">
                                        <textarea rows="2" class="form-control" placeholder="In Detail Report Of CT Scan" name="report"></textarea>
                                    </div>
                                </div>
                                <div class="col-sm-4">
                                      <div class="form-group">
  ...
  if(isset($_POST['Mark']))
     ...
     if(isset($_POST['Update1']))
    {
        if(isset($_POST['pid']) && isset($_POST['phytst']) && isset($_POST['anesthesia']) && isset($_POST['remark']) && isset($_POST['report']))
        {
            ...
            $result7=mysqli_query($conn,"INSERT INTO `hospital`.`ctscan` (`pid`, `remark`, `report`, `anesthesia`, `physicaltst`) VALUES ('$Apid', '$Remark ', '$Report', '$Anes', '$Physts')");
