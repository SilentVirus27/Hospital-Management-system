                                        ...
                                        <li>
                                            <div class="form-group">
                                                <select class="form-control show-tick" name="pid" >
                                                    ...
                                                    <?php 
                                                    $result4= mysqli_query($conn,"SELECT * FROM hospital.appointment where status='Waiting' and requestedServiceId='6'");
                            ...
                            <div class="table-responsive m-t-20">
                                <table class="table table-filter table-hover m-b-0 ">
                                    <tbody>
                                        ...
                                        <?php 
                                        $result6= mysqli_query($conn,"SELECT * FROM hospital.appointment where requestedServiceId='6'");
