                            ...
                            <div class="card top_counter">
                                <div class="body">
                                    ...
                                    <div class="content">
                                        ...
                                        <h5 class="number">$ <?php echo $revenuerow['grandtotal']; ?></h5>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row clearfix">
                                <div class="col-md-4">
                                    <div class="body bg-success text-light">
                                        <h4><i class="icon-wallet"></i> <?php echo $revenuerow['operationincome']; ?> $</h4>
                                        <span>Operation Income</span>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="body bg-warning text-light">
                                        <h4><i class="icon-wallet"></i> <?php echo $revenuerow['pharmacyincome']; ?> $</h4>
                                        <span>Pharmacy Income</span>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="body bg-danger text-light">
                                        <h4><i class="icon-wallet"></i> <?php echo $revenuerow['hospitalexpenses']; ?> $</h4>
