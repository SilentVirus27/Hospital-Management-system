                                        ...
                                        <li>
                                            <div class="form-group">
                                                <select class="form-control show-tick" name="pid" >
                                                    ...
                                                    <?php 
                                                    $result4= mysqli_query($conn,"SELECT * FROM hospital.appointment where requestedServiceId='7'");
                            ...
                            <div class="row clearfix">
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        <select class="form-control show-tick" name="apid" >
                                            <option value="">- patient Id -</option>
                                            <?php 
                                            $result4= mysqli_query($conn,"SELECT * FROM hospital.appointment where status='Waiting'");
                                            while($row=mysqli_fetch_assoc($result4)){
                                                echo"<option value='".$row['apid']." '>".$row['apid']."</option>";
                                                }
                                            ?>
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group m-t-20">
                                        <textarea rows="2" class="form-control" placeholder="In Detail Report Of X-Ray" name="report"></textarea>
                                    </div>
                                </div>
                                <div class="col-sm-4">
                                      <div class="form-group">
...
<?php
  ...
  if(isset($_POST['Mark']))
    ...
    {
        if(isset($_POST['apid']) && isset($_POST['phytst']) && isset($_POST['anesthesia']) && isset($_POST['remark']) && isset($_POST['report']))
        {
            $Apid=$_POST['apid'];
            $Phytst=$_POST['phytst'];
            ...
            $result7=mysqli_query($conn,"INSERT INTO `hospital`.`x_ray` (`pid`, `remark`, `report`, `anesthesia`, `physicaltst`) VALUES ('$Apid','$Rmark', '$Report', '$Anes', '$Phytst')");
            if($result7){
            echo"<script>window.alert('Successfully');</script>"; 
