                            ...
                            <h2>MRI Appoinments</h2>
                                    <ul class="header-dropdown">
                                        <div class="col-sm-13">
                                            ...
                                            <li>
                                                <div class="form-group">
                                                    <select class="form-control show-tick" name="pid" >
                                                        ...
                                                        <?php 
                                                        $result4= mysqli_query($conn,"SELECT * FROM hospital.appointment where requestedServiceId='10'");
                                            ...
                                            <li>
                                                <div class="action">
                                                        <button type="button" class="btn btn-sm -m2 btn-outline-secondary  js-sweetalert" title="Edit" name="Mark">Mark Diagnosed</button>
                                                </div>
                                            </li>
                                            </form>
                                        </div>
                            ...
                            <div class="table-responsive m-t-20">
                                <table class="table table-filter table-hover m-b-0 ">
                                    <tbody>
                                        ...
                                        <?php 
                                        $result6= mysqli_query($conn,"SELECT * FROM hospital.appointment where requestedServiceId='10'");
                                ...
                                <div class="col-sm-4">
                                 ...
                                 <div class="col-sm-12">
                                    <div class="form-group m-t-20">
                                        <textarea rows="2" class="form-control" placeholder="In Detail Report Of MRI" name="report"></textarea>
                                    </div>
                                </div>
                                <div class="col-sm-4">
                                      <div class="form-group">
...
<?php
  ...
  if(isset($_POST['Mark']))
    ...
    {
        if(isset($_POST['pid']) && isset($_POST['phytst']) && isset($_POST['anesthesia']) && isset($_POST['remark']) && isset($_POST['report']))
        {
            $Apid=$_POST['pid'];
            $Phytst=$_POST['phytst'];
            $Anes=$_POST['anesthesia'];
            $Remark=$_POST['remark'];
            $Report=$_POST['report'];

            $result7=mysqli_query($conn,"INSERT INTO `hospital`.`mri` (`pid`, `remark`, `report`, `anesthesia`, `physicaltst`) VALUES ('$Apid', '$Remark', '$Report', '$Anes', '$Phytst')");
